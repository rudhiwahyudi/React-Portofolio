...
const Contact = () => {
  useEffect(() => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm("service_u4c25bn", "template_ho2mxmm", form.current, {
          publicKey: "YkGhdE7DtkbHcEdli",
        })
       e.target.reset()
    };
  return (
        ...
        <div className="contact__content" data-aos="fade-up">
          ...
          <div className="contact__info" data-aos="fade-up">
            <div className="contact__card">
              ...
              <span className="contact__card-data">wahyudirudhi@gmail.com</span>

              <a
                href="mailto: rudhiwahydi0@gmail.com"
            ...
            <div className="contact__card" data-aos="fade-up">
              ...
              <span className="contact__card-data">0858-6511-0436</span>
            ...
            <div className="contact__card" data-aos="fade-up">
              ...
              <span className="contact__card-data">Rudhi Wahyudi</span>

              <a
                href="https://www.instagram.com/rudhi.wahyudi/"
                className="contact__button"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
